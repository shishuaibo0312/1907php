...
@section('content')
     <div class="userName">
      <dl class="names">
       <dt><img src="/static/index/images/011AA3D6B8B011F50615A7F9FA039C20.jpg" /></dt>
       <dd>
        <h3>Docotr异乡人</h3>
       </dd>
     ...
     <ul class="userNav">
      ...
      <li><span class="glyphicon glyphicon-map-marker"></span><a href="{{url('sitelist')}}">收货地址管理</a></li>
