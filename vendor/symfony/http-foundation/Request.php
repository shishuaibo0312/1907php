...
class Request
{
     ...
     *
     * Suppose that an admin.php file instantiates this request object:
     *
     *  * http://localhost/admin.php         returns an empty string
     *  * http://localhost/admin.php/page    returns an empty string
     *  * http://localhost/web/admin.php     returns '/web'
     *  * http://localhost/we%20b/admin.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
